...
const Navbar = () => {
  ...
  return (
    ...
    <nav>
        ...
        <ul>
        <li>
                <a href="#topics">Course Dtails</a>
            </li>

            <li>
                <a href="#infro">About</a>
            </li>
        ...
        <div className={`mobile-menu-container ${isActive ? "active" : ""}`}>
            ...
            <ul className="menu-items">
                <li>
                    <a  href="#topics" onClick={() => setIsActive(false)}>Course Dtails</a>
                </li>

                <li>
                    <a  href="#infro" onClick={() => setIsActive(false)}>About</a>
                </li>
